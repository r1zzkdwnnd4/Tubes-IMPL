...
<body class="bg-white">
    <h1 class="text-1xl font-semibold text-gray-800 mb-4 px-6">
        Selamat datang, <span class="text-primary-blue"><?php echo e(auth('customer')->user()->NamaCus); ?></span>
    </h1>
...
<?php /**PATH C:\laragon\www\travela\resources\views/pages/customerHome.blade.php ENDPATH**/ ?>