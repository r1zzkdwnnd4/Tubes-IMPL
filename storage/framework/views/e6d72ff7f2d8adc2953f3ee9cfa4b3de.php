...
<nav class="navbar navbar-expand-lg navbar-light bg-light py-3 px-5">
    <a class="navbar-brand ms-4" href="<?php echo e(route('home')); ?>"><h1>Travela Admin</h1></a>
    <div class="collapse navbar-collapse justify-content-end me-4">
        <ul class="navbar-nav">
            <li class="nav-item me-3">
                <span class="btn btn-secondary disabled">Admin Only</span>
            </li>
        </ul>
    </div>
</nav>
...
<div class="register-container">
    <div class="register-box">
        ...
        <form method="POST" action="<?php echo e(route('admin.login.process')); ?>">
            <?php echo csrf_field(); ?>
...
<?php /**PATH C:\laragon\www\Tubes-IMPL\resources\views/pages/adminLogin.blade.php ENDPATH**/ ?>