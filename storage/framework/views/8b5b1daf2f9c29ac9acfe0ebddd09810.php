...
<div class="ticket-container">
    ...
    <div class="ticket-body">
        ...
        <div class="ticket-row">
            ...
            <span><?php echo e(\Carbon\Carbon::parse($transaksi->Tanggal_Travel)->format('d M Y')); ?></span>
        </div>

        <div class="ticket-row">
            <span>Jumlah Orang:</span>
            <span><?php echo e($transaksi->Jumlah_Orang); ?> orang</span>
        </div>
        ...
        <div class="ticket-row">
            ...
            <strong class="kode-booking">
                <?php echo e($transaksi->Kode_Booking); ?>
        ...
        <div class="btn-container">
            <a href="<?php echo e(route('customer.home')); ?>" class="btn btn-home">
                Kembali ke Home
            </a>
