...
<nav class="navbar navbar-expand-lg navbar-light bg-light py-3 px-5">
    <a class="navbar-brand ms-4" href="<?php echo e(route('home')); ?>"><h1>Travela Agen</h1></a>
...
<div class="register-container">
    <div class="register-box">
        ...
        <form method="POST" action="<?php echo e(route('agen.login.process')); ?>">
            <?php echo csrf_field(); ?>
...
<?php /**PATH C:\laragon\www\Tubes-IMPL\resources\views/pages/agenLogin.blade.php ENDPATH**/ ?>