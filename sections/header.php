<header class="fixed top-0 left-0 right-0 z-50 bg-white shadow-md">
    <nav class="max-w-7xl mx-auto px-4 lg:px-8 py-4 flex justify-between items-center">
        ...
        <div class="flex items-center space-x-2">
            ...
            <a href="#" class="text-xl font-bold text-gray-800">Travela</a>
        </div>

        <div class="flex items-center space-x-6">
            <!-- Added class: nav-link -->
            ...
            <a href="booking.php" class="bg-primary-blue hover:bg-blue-700 text-white font-semibold py-2 px-4 rounded-lg shadow-md">
    Book Now
            </a>
