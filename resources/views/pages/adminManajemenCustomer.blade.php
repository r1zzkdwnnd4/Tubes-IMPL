                    ...
                    <tbody class="bg-white text-black">
                        @foreach ($customers as $cust)
                            <tr class="border-b hover:bg-gray-50">
                                <td class="p-3">{{ $cust->Id_cust }}</td>
                                <td class="p-3">{{ $cust->NamaCustomer }}</td>
                                <td class="p-3">{{ $cust->Email }}</td>
                                <td class="p-3">{{ $cust->NoHP }}</td>
                                ...
                                <td class="p-3 text-center flex items-center gap-3 justify-center">
                                    ...
                                    <button
                                        onclick="openEditModal(
                                            ...
                                            '{{ $cust->Email }}',
                                            '{{ $cust->NoHP }}',
                                            '{{ route('admin.customer.update', $cust->Id_cust) }}'
                                        )"
                                    ...
                                    <!-- DELETE -->
                                    <form action="{{ route('admin.customer.delete', $cust->Id_cust) }}"
                                          method="POST"
